...
bullets fips: A five-digit number (represented as a string) indicating the U.S. county

bullets SCC: The name of the source as indicated by a digit string (see source code classification table)
